...
이를 가능하게 하는 기술로 useSyncExternalState를 선정하게 됐습니다. 이 훅에 대한 자세한 내용은 [제 블로그](https://leirbag.tistory.com/144)나 [공식문서](https://react.dev/reference/react/useSyncExternalStore)에 나와있으므로 설명을 간략히 하자면 useSyncExternalStore는 React DOM 내부가 아닌 외부 저장소(JS)에서 React DOM을 조작할 수 있도록 하는 커스텀 훅입니다.
